...
$serviceExePath = @"C:\Users\LENOVO\source\repos\WindowsServiceC\WindowsServiceC\bin\Debug\WindowsServiceC.exe"
$serviceName = "YWindowsServiceC"
$serviceDescription = "My Windows Service Description WindowsServiceC"
$logFilePath = @"C:\Users\LENOVO\source\repos\WindowsServiceC\PSLogFile.txt"
